...
class ColorSaverSetting(settings: String, path: Array<String>, id: String, defaultValue: ColorSaver, elementOptions: DefaultSettingElementOptions?) :
    Setting<ColorSaver, DefaultSettingElementOptions>(settings, path, id, defaultValue, elementOptions ?: DefaultSettingElementOptions()) {
