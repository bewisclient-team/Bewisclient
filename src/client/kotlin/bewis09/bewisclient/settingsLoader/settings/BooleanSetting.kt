...
open class BooleanSetting(settings: String, path: Array<String>, id: String, defaultValue: Boolean, elementOptions: BooleanSettingsElementOptions?) :
    Setting<Boolean, BooleanSettingsElementOptions>(settings, path, id, defaultValue, elementOptions ?: BooleanSettingsElementOptions()) {
