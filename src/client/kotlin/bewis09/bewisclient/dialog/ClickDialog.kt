...
class ClickDialog(val text: Text, val clickText: Text, val onClick: ((() -> Unit) -> Unit)) : Dialog(5000) {
    ...
    override fun renderText(context: DrawContext, width: Int, y: Int, mouseX: Int, mouseY: Int): Int {
        ...
        hovered =
            mouseX * MainOptionsScreen.scale > (width - getWidth(width)) && mouseX * MainOptionsScreen.scale < width && mouseY * MainOptionsScreen.scale > (y + lines.size * 11 + 5) && mouseY * MainOptionsScreen.scale < (y + lines.size * 11 + 17)
